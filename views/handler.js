        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (!isPrems && plugin.diamond && global.db.data.users[m.sender].diamond < plugin.diamond * 1) {
                    this.reply(m.chat, `coin kamu tidak mencukupi, mainkan menu game untuk mendapatkan coin`, m)
                ...
                try {
                    ...
                    if (m.diamond)
                        m.reply(`*${+m.diamond}* 🪙 telah digunakan`)
                }
                break
            }
        }
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = 'https://telegra.ph/file/456a7ccd120fd1a7dda94.png'
                            let lea = 'https://telegra.ph/file/1a95c06da6fac17f456ab.png'
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: `Perintah ini hanya dapat digunakan oleh *Real Owner*!`,
...
premium: 'fitur ini hanya bisa diakses user premium',
