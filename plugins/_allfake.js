...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '6283133162295@s.whatsapp.net'), '𝐏𝐚𝐭𝐫𝐢𝐜𝐤 𝐁𝐨𝐭', 'wkaka', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					mediaUrl: sgc,
					description: '𝐏𝐚𝐭𝐫𝐢𝐜𝐤 𝐁𝐨𝐭',
					previewType: "PHOTO",
					thumbnail: await (await fetch(pp)).buffer(),
					sourceUrl: "https://chat.whatsapp.com/BH0psoLqEHR8r8GngPcdNl",					
				}
			}
		}
		global.fakeig = {
