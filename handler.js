          ...
          //          continue
             //   }
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                    this.reply(m.chat, `Coin Kamu Habis 😞\n_mainkan menu games untuk mendapatkan coin_`, m)
...
let msg = {
  ...
  if (msg) return conn.sendButton(m.chat, `${ucapan()} ` + tag, msg + '\n\n\n\n', [['sorry', 'huuu']], m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    description: sgc,
    title: "Euphyllia - MD",
    body: wm,
    thumbnail: fs.readFileSync('./thumbnail.jpg'),
